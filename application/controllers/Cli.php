...
class Cli extends Frontend_Controller 
{
	...
	*/
	public function index()
	{
		...
		echo "functions :\n";
		echo "  - up [version] : migrate database to latest or a specific higher version\n";
		echo "  - down [version] : migrate database down one version or to a specific lower version\n";

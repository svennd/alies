						...
						<div class="row mt-3">
							...
							<div class="col-sm-6">
								...
								<tr>
									...
									<td>
										<?php 
											$price_to_show = ($cat_price) ? $cat_price : (((isset($product['buy_price'])) ? $product['buy_price'] : ""));
											echo ($cat_price) ? '' : '<i class="fa-solid fa-user-pen" title="' . $this->lang->line('price_alies') . ', ' . $product['buy_price_date'] . '"></i> ';
											echo $price_to_show;

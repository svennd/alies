...
*/
		...
		infoHtml += 'CTI: ' + (item.cti || '-') + '<br>';
		infoHtml += 'CTI uitgebreid: ' + (item.cti_extended || '-') + '<br>';
		infoHtml += 'CNK: ' + (item.cnk || '-') + '<br>';
		infoHtml += 'VHB: ' + (item.VHB || '-') + '<br>';
		infoHtml += 'Status melding: ' + (item.status_melding || '-') + '<br>';
		infoHtml += 'Tot: ' + (item.tot || '-') + '<br>';
		infoHtml += 'Reden: ' + (item.reden || '-') + '<br>';
		infoHtml += 'Impact: ' + (item.impact || '-') + '<br>';
		infoHtml += 'Geneesmiddel: ' + (item.geneesmiddel || '-') + '<br>';
		infoHtml += 'Werkzaam bestanddeel: ' + (item.werkzaam_bestanddeel || '-') + '<br>';
		infoHtml += 'ATC code: ' + (item.atc || '-') + '<br>';

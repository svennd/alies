...
<div class="row">
	...
	<?php if ($bill['status'] != PAYMENT_PAID): ?>
		...
		<i><small id="payment_info" class="form-text text-muted ml-2">&nbsp;</small></i>
			<button type="submit" name="submit" value="1" class="btn btn-outline-success my-3 mx-3"><i class="fas fa-file-invoice-dollar"></i> Payment Complete</button>
		...
		<!-- <a href="<?php echo base_url(); ?>invoice/print_bill/<?php echo $bill_id; ?>" class="btn btn-outline-secondary my-3 mx-3" target="_blank"><i class="fas fa-print"></i> print</a> -->

		<?php endif; ?>
			<?php if ($bill['status'] != PAYMENT_PAID): ?>
			<a href="<?php echo base_url(); ?>invoice/bill_unpay/<?php echo $bill_id; ?>" class="btn btn-outline-danger my-3 mx-3" target="_blank"><i class="fas fa-syringe"></i> Drop from stock</a>	
		<?php endif; ?>
		  </form>		

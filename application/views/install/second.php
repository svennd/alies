			...
			<p class="card-text">
				<form action="<?php echo base_url(); ?>install/third" method="post" autocomplete="off">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?php echo base_url(); ?>" id="base_url" aria-describedby="base_url_help">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="db_username" placeholder="localhost" />
					</div>
					<div class="form-group">
						<label for="db_passwd">Database Password</label>
						<input type="password" class="form-control" id="db_passwd" placeholder="********" />
					</div>
					<div class="form-group">
						<label for="db_name">Database Name</label>
						<input type="text" class="form-control" id="db_name" placeholder="" />
					</div>

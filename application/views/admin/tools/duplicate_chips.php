	...
	<p>
			...
			<div class="card-header d-flex flex-row align-items-center justify-content-between">
				<div><a href="<?php echo base_url(); ?>tools"><?php echo $this->lang->line('tools'); ?></a> / duplicate pet finder</div>
			</div>
                    ...
                    <?php foreach ($duplicates as $dup): ?>
                        <tr>
                            <td>
                                    <?php 
                                        // IDs 
                                        $ids = explode(",", $dup['pet_ids']);
                                        $count = 0;
                                        foreach($ids as $owner_id): ?>
                                        <a href="<?php echo base_url('pets/fiche/' . $owner_id); ?>"><?php echo $owner_id; ?></a>
                                        <?php
                                            $count++;

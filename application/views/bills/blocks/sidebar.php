<div class="col-lg-3 mb-4">
    <?php if ($bill['status'] != PAYMENT_PAID): ?>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" class="form-control" id="totalincbtw" name="clientid" value="<?php echo $bill['amount']; ?>" disabled />
        ...
        <!-- comment -->
        <h6><a data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><?php echo $this->lang->line('comment'); ?></a></h6>
						<hr>
    ...
    <?php if ($bill['status'] == PAYMENT_PAID): ?>
        ...
        <div class="form-group">
            <label for="msg_invoice"><?php echo $this->lang->line('comment'); ?> (<?php echo $this->lang->line('comment_internal'); ?>)</label>
    ...
    <?php if ($bill['status'] != PAYMENT_PAID && $bill['status'] != PAYMENT_PARTIALLY): ?>
        <a href="<?php echo base_url(); ?>invoice/bill_unpay/<?php echo $bill_id; ?>" class="btn btn-outline-danger mx-2 shakeit" id="bill_unpay" onclick="event.preventDefault()"><i class="fa-solid fa-house-medical-circle-xmark"></i> <?php echo $this->lang->line('drop_from_stock'); ?></a>
    <?php endif; ?>

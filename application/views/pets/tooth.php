<div class="row">
	<div class="col-lg-12 mb-4">
			...
			<div class="card-header">
				<a href="<?php echo base_url('owners/detail/'. $pet_info['owners']['id']); ?>"><?php echo $pet_info['owners']['last_name'] ?></a> / 
				<a href="<?php echo base_url('pets/fiche/' . $pet_info['id']); ?>"><?php echo $pet_info['name'] ?></a> / <?php echo $this->lang->line('teeth'); ?>
			</div>
			<div class="card-body">
			...
			<div class="mb-2">
				<div class="row">
					<div class="col-lg-8">
						...
						<label for="head"><?php echo $this->lang->line('paint_color') ?></label>
						
					</div>
					<div class="col-lg-4">
						<div class="alert alert-success" id="tooth_update_alert" style="display:none;" role="alert">&nbsp;</div>
					</div>
      ...
      <div class="card shadow mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    <a  href="<?php echo base_url('tooth/history/' . $pet_id); ?>" role="button" id="dropdownMenuLink">
...
document.addEventListener("DOMContentLoaded", function(){
	...
	$(".tooth").click(function() {
		...
		$.ajax({
		 url:'<?php echo base_url('tooth/update/' .  $pet_id); ?>',
		 method: 'post',

<div class="card mb-4">
	...
	<div class="card-body">
		...
		<a href="<?php echo base_url(); ?>tooth/fiche/<?php echo $pet['id']; ?>" class="btn btn-success btn-icon-split ml-5"><span class="icon text-white-50"><i class="fas fa-tooth"></i></span><span class="text">Tooth</span></a>

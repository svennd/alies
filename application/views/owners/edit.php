					...
					<div class="col-md-6">
						...
						<div class="form-row">
								...
								<div class="form-group col-md-4">
									...
									<input type="text" name="nr" class="form-control" id="nr" autocomplete="dezzd" value="<?php echo (isset($owner['nr'])) ? $owner['nr']: '' ?>"  maxlength="30">
								</div> 
							</div>
						<div class="form-row">
							<div class="form-group col-md-2">
							<label for="inputZip"><?php echo $this->lang->line('zip'); ?></label>
							<input type="text" name="zip"  class="form-control" id="inputZip" autocomplete="dezzd" value="<?php echo (isset($owner['zip'])) ? $owner['zip']: '' ?>" maxlength="6">
							</div>
							<div class="form-group col">

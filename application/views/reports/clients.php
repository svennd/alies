<div class="row"> 
	<div class="col-lg-10 mb-4">
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<a href="<?php echo base_url(); ?>export/clients/30" class="btn btn-success"><i class="fas fa-file-export"></i> 30 days</a> 
				<a href="<?php echo base_url(); ?>export/clients/90" class="btn btn-success"><i class="fas fa-file-export"></i> 90 days</a>
				<a href="<?php echo base_url(); ?>export/clients" class="btn btn-warning ml-3"><i class="fas fa-file-export"></i> All Clients</a>
				<br>
